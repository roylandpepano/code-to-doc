    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="ml-2">Approved Edit Destination Requests</h1>
                    </div><!-- /.col -->
                    ...
                    <table id="newTourOperatorRequests" class="table table-striped table-bordered table-light table-responsive-xl text-wrap" style="text-align: center">
                        ...
                        @foreach($requests as $request)
                            <tr>
                                ...
                                <td><span class="badge bg-success" style="color: white !important;">{{ $request->edit_dest_approval }}</span></td>
                                ...
                                <td>
                                    <button class="btn btn-outline-primary btn-sm" type="submit" data-bs-toggle="tooltip" data-bs-placement="top" title="View Record"
                                            onClick="location.href='{{ route('admin.requests.edit_destination.approved.show', [$request->destination_id,$request->user_id]) }}'">
