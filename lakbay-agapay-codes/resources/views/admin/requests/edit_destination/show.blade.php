            ...
            <div class="container-fluid">
                <div class="row mb-2 header-show">
                    ...
                    <div class="col-sm-4" style="display:flex; justify-content: center; align-items: center; text-align: center">
                        <h4 class="header-show text-warning">• Pending Edit Destination Request •</h4>
                    </div>
                                    ...
                                    <div class="col-12 col-lg-8 m-auto">
                                        ...
                                        <form class="multisteps-form__form" id="add_form" action="{{ route('admin.approve.edit_destination.requests', [$request->destination_id, $request->user_id]) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="slideHorz">
                                                <h3 class="multisteps-form__title">SUGGESTED Destination Details</h3>
                                                <div class="multisteps-form__content">
                                                    ...
                                                    <div class="form-row mt-4">
                                                        ...
                                                        <div class="col">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" value="0" name="dest_operating" id="flexRadioDefault2"  @if($request->dest_operating == '0') checked @endif/>
                                                                <label class="form-check-label" for="flexRadioDefault2"> Yes </label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" value="1" name="dest_operating" id="flexRadioDefault1" @if($request->dest_operating == '1') checked @endif/>
                                                    ...
                                                    <div class="form-row mt-4">
                                                        ...
                                                        <div class="col">
                                                            <textarea class="multisteps-form__textarea form-control" name="destination_description">{{ $request->dest_description }}</textarea>
                                                    ...
                                                    <div class="form-row mt-4">
                                                        ...
                                                        <div class="col">
                                                            <input class="multisteps-form__input form-control" name="destination_date_opened" value="{{ $request->dest_date_opened }}" type="date"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-row mt-4">
                                                        <div class="col-12">
                                                        ...
                                                        <div class="col">
                                                            <textarea class="multisteps-form__textarea form-control" name="destination_working_hours">{{ $request->dest_working_hours }}</textarea>
                                                    ...
                                                    <div class="form-row mt-4">
                                                        ...
                                                        <div class="col">
                                                            <select class="multisteps-form__select form-select" name="dest_category" aria-label="Default select example">
...
{{--                                                ORIGINAL DETAILS--}}
                                                ...
                                                <div class="mt-4 p-4 rounded bg-dark">
                                                    ...
                                                    <div class="multisteps-form__content">
                                                        ...
                                                        <div class="form-row mt-4">
                                                            ...
                                                            <div class="col">
                                                                <div class="form-check">
                                                                    <input class="form-check-input read" type="radio" value="0" id="flexRadioDefault2"  @if($destination->dest_operating == '0') checked @endif readonly/>
                                                                    <label class="form-check-label" for="flexRadioDefault2"> Yes </label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input read" type="radio" value="1" id="flexRadioDefault1" @if($destination->dest_operating == '1') checked @endif readonly/>
                                                                    <label class="form-check-label" for="flexRadioDefault1"> No </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="slideHorz">
                                                <h3 class="multisteps-form__title">SUGGESTED Location</h3>
                                                <div class="multisteps-form__content">
                                                    <div class="row">
                                                        <div class="form-row mt-4">
                                                            <div class="col-12">
...
{{--                                                ORIGINAL LOCATION--}}
                                            ...
                                            <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="slideHorz">
                                                <h3 class="multisteps-form__title">SUGGESTED Contact Information</h3>
                                                <div class="multisteps-form__content">
                                                    <div class="form-row mt-4">
                                                        <div class="col-12">
                                                            <label>Email</label>
                                                        ...
                                                        <div class="col">
                                                            <input class="multisteps-form__input form-control" name="dest_email" type="text" value="{{ $request->dest_email }}"/>
                                                        </div>
                                                        <div class="col-12">
                                                            <label>Phone</label>
                                                        </div>
                                                        <div class="col">
                                                            <input class="multisteps-form__input form-control" name="dest_phone" type="text" value="{{ $request->dest_phone }}"/>
                                                        </div>
                                                        <div class="col-12">
...
{{--                                                ORIGINAL Contacts--}}
                                                ...
                                                <div class="mt-4 p-4 rounded bg-dark">
                                                    ...
                                                    <div class="multisteps-form__content">
                                                        <div class="form-row mt-4">
                                                            ...
                                                            <div class="col">
                                                                <input class="multisteps-form__input form-control"type="text" value="{{ $destination->dest_email }}" readonlyd/>
                                                            </div>
                                                            <div class="col-12">
                                                                <label>Phone</label>
                                                            </div>
                                            ...
                                            <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="slideHorz">
                                                <h3 class="multisteps-form__title">SUGGESTED Other Details</h3>
                                                <div class="multisteps-form__content">
                                                    <div class="form-row mt-4">
                                                        <div class="col-12">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('.read:radio:not(:checked)').attr('disabled', true);
