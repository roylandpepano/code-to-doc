    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="ml-2">Pending Edit Destination Requests</h1>
                    </div><!-- /.col -->
                    ...
                    <table id="newTourOperatorRequests" class="table table-striped table-bordered table-light table-responsive-xl text-wrap" style="text-align: center">
                        ...
                        @foreach($requests as $request)
                            <tr>
                                ...
                                <td><span class="badge bg-warning" style="color: white !important;">{{ $request->edit_dest_approval }}</span></td>
                                ...
                                <td>
                                    ...
                                    onClick="location.href='{{ route('admin.requests.edit_destination.show', [$request->destination_id,$request->user_id]) }}'">
