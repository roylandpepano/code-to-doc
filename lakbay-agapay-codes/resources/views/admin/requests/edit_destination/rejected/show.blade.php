            ...
            <div class="container-fluid">
                <div class="row mb-2 header-show">
                    ...
                    <div class="col-sm-4" style="display:flex; justify-content: center; align-items: center; text-align: center">
                        <h4 class="header-show text-danger">• Rejected Edit Destination Request •</h4>
                    </div>
                    <div class="col-sm-4 header-btn">
                        @if ($errors->any())
                            <button type="button" style="max-height: 40px" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Go Back on Previous Page"
                                    onclick="location.href='{{ route('admin.requests.edit_destination.rejected.index') }}'">
                                    ...
                                    <div class="col-12 col-lg-8 m-auto">
                                        ...
                                        <form class="multisteps-form__form" id="add_form" action="{{ route('admin.approve.edit_destination.requests', [$request->destination_id, $request->user_id]) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="slideHorz">
                                                <h3 class="multisteps-form__title">REJECTED Destination Details</h3>
                                                <div class="multisteps-form__content">
                                                    ...
                                                    <div class="form-row mt-4">
                                                        ...
                                                        <div class="col">
                                                            <input class="multisteps-form__input form-control" name="destination_date_opened" value="{{ $request->dest_category }}" type="text" readonly/>
                                                        </div>
                                                    </div>
                                                    <div class="button-row d-flex mt-4">
                                                ...
                                                <div class="mt-4 p-4 rounded bg-dark">
                                                    ...
                                                    <div class="multisteps-form__content">
                                                        ...
                                                        <div class="form-row mt-4">
                                                            ...
                                                            <div class="col">
                                                                <input class="multisteps-form__input form-control" name="destination_date_opened" value="{{ $destination->dest_category }}" type="text" readonly/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="slideHorz">
                                                <h3 class="multisteps-form__title">REJECTED Location</h3>
                                                <div class="multisteps-form__content">
                                                    <div class="row">
                                                        <div class="form-row mt-4">
                                                            <div class="col-12">
                                                        ...
                                                        <div class="form-row mt-4">
                                                            ...
                                                            <div class="col">
                                                                <input class="multisteps-form__input form-control" value="{{ $request->dest_city }}" type="text" readonly/>
                                            ...
                                            <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="slideHorz">
                                                <h3 class="multisteps-form__title">REJECTED Contact Information</h3>
                                                <div class="multisteps-form__content">
                                                    <div class="form-row mt-4">
                                                        <div class="col-12">
                                                            <label>Email</label>
                                            ...
                                            <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="slideHorz">
                                                <h3 class="multisteps-form__title">REJECTED Other Details</h3>
                                                <div class="multisteps-form__content">
                                                    <div class="form-row mt-4">
                                                        <div class="col-12">
