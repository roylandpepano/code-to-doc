    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="ml-2">Rejected New Destination Requests</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6 header-btn">
                        ...
                        <form action="{{ route('admin.requests.new_destination.index') }}" method="GET">
                    ...
                    <table id="touristRequests" class="table table-striped table-bordered table-light table-responsive-xl text-wrap" style="text-align: center">
                        ...
                        @foreach($requests as $request)
                            <tr>
                                ...
                                <td><span class="badge bg-danger" style="color: white !important;">{{ $request->dest_approval }}</span></td>
                                <td>{{ Carbon\Carbon::parse($request->dest_created)->isoFormat('LLLL') }}</td>
                                <td>{{ Carbon\Carbon::parse($request->dest_updated)->isoFormat('LLLL') }}</td>
                                <td>
                                    <form action="{{ route('admin.requests.new_destination.rejected.show', $request->dest_id) }}" method="GET">
