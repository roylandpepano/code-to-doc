            ...
            <div class="container-fluid">
                <div class="row mb-2 header-show">
                    ...
                    <div class="col-sm-4" style="display:flex; justify-content: center; align-items: center; text-align: center">
                        <h4 class="header-show text-success">• Approved New Tour Operator Request •</h4>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-8 ml-auto mr-auto mb-4">
                                        <div class="multisteps-form__progress">
                                            ...
                                            <button class="multisteps-form__progress-btn" type="button" id="details" title="Details">Details</button>
                                            ...
                                            <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="slideHorz">
                                                ...
                                                <div class="multisteps-form__content">
                                                    ...
                                                    <div class="form-row mt-4">
                                                        ...
                                                        <div class="col">
                                                            <textarea class="multisteps-form__textarea form-control" id="operator_location" name="operator_location" disabled>{{ $request->operator_location }}</textarea>
...
{{--    Contact Information--}}
                                            <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="slideHorz">
                                                ...
                                                <div class="multisteps-form__content">
                                                    <div class="form-row mt-4">
                                                        ...
                                                        <div class="col">
                                                            <input class="multisteps-form__input form-control" id="operator_email" name="operator_email" type="text" value="{{ $request->operator_email }}" disabled/>
                                                        </div>
                                                        <div class="col-12">
                                                            <label>Phone</label>
                                                        </div>
                                                        <div class="col">
                                                            <input class="multisteps-form__input form-control" id="operator_phone" name="operator_phone" type="text" value="{{ $request->operator_phone_number }}" disabled/>
                                                        </div>
                                                        <div class="col-12">
                                                        ...
                                                        @forelse($packages as $package)
                                                            <div class="multisteps-form__content" id="increase_package">
                                                                ...
                                                                <div class="form-row mt-3">
                                                                    ...
                                                                    <div class="col">
                                                                        <textarea class="multisteps-form__input form-control" name="package_minimum_fee[]" type="text" placeholder="Package Minimum Fee" disabled>{{ $package->package_minimum_fee }}</textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-row mt-3">
                                                                    <div class="col-12">
                                                                    ...
                                                                    <div class="col">
                                                                        <textarea class="multisteps-form__input form-control" name="package_rate[]" type="text" placeholder="Rate" disabled>{{ $package->package_rate }}</textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-row mt-3">
                                                                    <div class="col-12">
                                                        ...
                                                        @empty
                                                            <div class="multisteps-form__content" id="increase_package">
                                                                <div class="form-row mt-4">
                                                                    ...
                                                                    <div class="col">
                                                                        <input class="multisteps-form__input form-control package_name" name="package_name[]" id="package_name" type="text" placeholder="Package Name" disabled/>
                                                                    </div>
                                                                </div>
                                                                <div class="form-row mt-3">
                                                                    <div class="col-12">
                                                                ...
                                                                <div class="form-row mt-3">
                                                                    ...
                                                                    <div class="col">
                                                                        <textarea class="multisteps-form__input form-control" name="package_minimum_fee[]" type="text" placeholder="Minimum Fee" disabled></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-row mt-3">
                                                                    <div class="col-12">
                                                                    ...
                                                                    <div class="col">
                                                                        <textarea class="multisteps-form__input form-control" name="package_rate[]" type="text" placeholder="Rate" disabled></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-row mt-3">
                                                                    <div class="col-12">
                                                ...
                                                <div class="multisteps-form__content " style="font-size: large; text-align: center">
                                                    <div class="user-info">
                                                        <div class="col-12" style="align-items: center">
                                                            <img src="{{ asset($request->user_picture) }}" alt="profile_pic" class="rounded-circle" style="height: 130px; width: 130px; object-fit:cover;">
                                                            <br><br/>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="contactLabel"><strong>Edit Tour Operator</strong></h4>
                                                        </div>
                                            ...
                                            <div class="modal fade" id="reject" tabindex="-1" role="dialog" aria-labelledby="rejectLabel" data-backdrop="static"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="contactLabel"><strong>Remove Tour Operator</strong></h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="container-fluid">
                                                                <div class="row">
                                                                    <div class="col-md">
                                                                        ...
                                                                        <span class="text-danger">@error('reason'){{ $message }}@enderror</span>
                                                                        <br/>
                                                                        <span style="color: gray;">Removed Tour Operators will be moved to rejected list.</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
