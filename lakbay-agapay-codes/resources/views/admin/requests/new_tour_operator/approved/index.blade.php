    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="ml-2">Approved New Tour Operator Requests</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6 header-btn">
                        ...
                        <form action="{{ route('admin.requests.new_tour_operator.rejected.index') }}" method="GET">
                            <button type="submit" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="View Rejected Requests">
                                <i class="fa-solid fa-circle-check mr-2"></i>Rejected Requests</button>
                        </form>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <table id="touristRequests" class="table table-striped table-bordered table-light table-responsive-xl text-wrap" style="text-align: center">
                        ...
                        @foreach($requests as $request)
                            <tr>
                                ...
                                <td><span class="badge bg-success" style="color: white !important;">{{ $request->operator_approval }}</span></td>
                                ...
                                <td>
                                    <button class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="View Record"
                                            onclick="location.href='{{ route('admin.requests.new_tour_operator.approved.show', $request->to_id) }}'">
