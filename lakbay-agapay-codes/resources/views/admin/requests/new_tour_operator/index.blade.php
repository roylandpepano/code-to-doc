    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="ml-2">Pending Tourist Requests</h1>
                    </div><!-- /.col -->
                    ...
                    <table id="newTourOperatorRequests" class="table table-striped table-bordered table-light table-responsive-xl text-wrap" style="text-align: center">
                        ...
                        @foreach($requests as $request)
                            <tr>
                                ...
                                <td><span class="badge bg-warning" style="color: white !important;">{{ $request->operator_approval }}</span></td>
                                ...
                                <td>
                                    <button class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="View Record"
                                            onclick="location.href='{{ route('admin.requests.new_tour_operator.show', $request->to_id) }}'">
