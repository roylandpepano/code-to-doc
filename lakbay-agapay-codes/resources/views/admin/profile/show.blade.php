...
{{--                    </div>--}}
        ...
        <div style="width: 90%; max-width: 700px; margin: auto;">
            <div class="shadow p-4 rounded bg-white mb-5">
                <h3 class="multisteps-form__title">My Profile</h3>
                <br/>
                <div class="multisteps-form__content ">
                    <div class="user-info col-lg-12 col-sm-6">
                        <div class="col-6 user-pic mr-auto ml-auto" style="text-align: center;">
                            <div class="rounded-circle">
                                <img src="{{ asset($users->user_picture) }}" alt="profile_pic" style="object-fit:cover;">
                            </div>
