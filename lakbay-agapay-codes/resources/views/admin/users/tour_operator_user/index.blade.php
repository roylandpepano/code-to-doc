    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="ml-2">Tour Operators</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6 header-btn">
                        ...
                        <button type="buttton" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="top" title="View Tour Operator Users">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="View Record"
                                            onclick="location.href='{{ route('admin.users.tour_operator_user.show', $user->id) }}'">
