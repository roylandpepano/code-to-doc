            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 header-btn">
                        ...
                        <button type="buttton" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="top" title="View Super Admin Users">
                            Super Admins</button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="View Record"
                                            onclick="location.href='{{ route('admin.users.super_admin_user.show', $user->id) }}'">
