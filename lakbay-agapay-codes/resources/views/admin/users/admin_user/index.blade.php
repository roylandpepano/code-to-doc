            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 header-btn">
                        ...
                        <button style="color: white !important;" type="button" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="top" title="View Admin Users">
                            Admins</button>
                        ...
                        <form action="{{ route('admin.users.index') }}" method="GET">
                            <button type="submit" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="View All Users">
                                All Users</button>
                        </form>
                    </div><!-- /.col -->
                </div><!-- /.row -->
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card-body table-responsive table-tourist-requests table table-striped table-bordered table-light" style="height: 100vh;">
                    <table id="adminUsers" class="table table-striped table-bordered table-light table-responsive-xl text-nowrap">
                        <thead>
                        <tr>
                            <th>Type</th>
                            <th>Name</th>
                            ...
                            <tr>
                                ...
                                <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                                    ...
                                    <button class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="View Record"
                                            onclick="location.href='{{ route('admin.users.admin_user.show', $user->id) }}'">
...
@push('scripts')
    <script>
        $(document).ready(function () {
            let table = $('#adminUsers').DataTable({
                responsive: true,
                "aaSorting": []
            });
        });
