                                ...
                                <div class="card-body">
                                    ...
                                    <div class="small text-muted">
                                        <div style="color:mediumseagreen">
                                            <strong>Price starts at Php {{$package->dest_pkg_min_fee}}</strong>
                                        </div>
                                    </div>
                                    <p class="card-text">{{Str::limit($package->dest_pkg_description, 100, $end='.....')}}</p>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="modalLabel">
                                                        <strong>{{$package->dest_pkg_name}}</strong></h4>
                                                ...
                                                <div class="modal-body">
                                                    <div class="container-fluid">
                                                        <div>
                                                            <center><p style="white-space: pre-wrap;text-align: justify">{{$package->dest_pkg_description}}</p></center>
                                                        </div>
                                                        <div>
                                                            <h5>Rate</h5>
                                                            <center><p style="white-space: pre-wrap;text-align: justify">{{ $package->dest_pkg_rate }}</p></center>
                                                        </div>
                                                        <div>
                                                            <h5>Inclusions</h5>
                                                            <center><p style="white-space: pre-wrap;text-align: justify">{{$package->dest_pkg_inclusions}}</p></center>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
