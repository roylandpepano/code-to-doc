        ...
        <div class="m-header">
            <nav>
                ...
                <nav class="m-header-right">
                    ...
                    <a href="#" type="button" onClick="window.location.reload();"><i class="fas fa-sync-alt"></i></a>
                    <a href="{{ route('tourist.home') }}"><i class="fas fa-home"></i></a>
        ...
        <div class="m-body contacts-container">
           ...
           <div class="@if($type == 'user') show @endif messenger-tab users-tab app-scroll" data-view="users">
               ...
               <div class="favorites-section">
                <p class="messenger-title">Contacts</p>
        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <div class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                    ...
                    <div class="avatar av-s header-avatar" style="margin: -5px 10px; background-image: url('');"></div>
                    <a href="#" class="user-name">{{ config('chatify.name') }}</a>
                </div>
                {{-- header buttons --}}
                <nav class="m-header-right">
                    <a href="#"><i class="fas fa-sitemap pages-btn"></i></a>
...
<script>
    ...
    $("#pagesOwned").popover({html:true, sanitize : false});
</script>
